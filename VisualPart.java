...
public class VisualPart extends JFrame {
	...
	public VisualPart() throws IOException {
		...
		labelDoorEntry.setIcon(new ImageIcon(ImageIO.read(VisualPart.class.getResource("/sourse/opendoor.png"))
		...
		labelDoorExit.setIcon(new ImageIcon(ImageIO.read(VisualPart.class.getResource("/sourse/opendoor.png"))
		...
		labelDoorQueue.setIcon(new ImageIcon(ImageIO.read(VisualPart.class.getResource("/sourse/closedoor.png"))
		...
		labelComp1.setIcon(new ImageIcon(ImageIO.read(VisualPart.class.getResource("/sourse/imgcomp.png"))
		...
		labelComp2.setIcon(new ImageIcon(ImageIO.read(VisualPart.class.getResource("/sourse/imgcomp.png"))
		...
		labelComp3.setIcon(new ImageIcon(ImageIO.read(VisualPart.class.getResource("/sourse/imgcomp.png"))
